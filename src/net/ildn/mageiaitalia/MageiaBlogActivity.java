...
public class MageiaBlogActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "Mageiaitalia.org - BlogActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.mageiafeedblog);
