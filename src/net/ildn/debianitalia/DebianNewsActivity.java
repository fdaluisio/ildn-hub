...
public class DebianNewsActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "debianitalia.org - NewsActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.debianfeednews);
