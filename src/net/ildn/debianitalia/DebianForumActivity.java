...
public class DebianForumActivity extends GlobalMenu {
	
	private DataRetriever dataRetriever;
	private static final String LOG_ID = "debianitalia.org - ForumActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.debianfeedforum);
