...
public class MandrivaGuideActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "mandrivaitalia.org - GuideActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.mandrivafeedguide);
