...
public class MandrivaNewsActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "mandrivaitalia.org - NewsActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.mandrivafeednews);
