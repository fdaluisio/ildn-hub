...
public class SuseBlogActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "suseitalia.org - BlogActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.susefeedblog);
