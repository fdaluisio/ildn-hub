...
public class DebianGuideActivity extends GlobalMenu {

	private DataRetriever dataRetriever;
	private static final String LOG_ID = "debianitalia.org - GuideActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String urlFeed = this.getString(R.string.debianfeedguide);
